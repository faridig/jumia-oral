...
**Critères d'Acceptation** :
- [x] Suppression du flux de demande de ville dans `src/session_manager.py`.
- [x] Retrait de la persistance de localisation dans le `SimpleChatStore`.
- [x] Mise à jour du prompt système pour interdire toute mention de ville ou de logistique locale.
...
**Critères d'Acceptation** :
- [x] Suppression des mentions Trust Score et VFM (obsolètes).
- [x] Suppression des sections sur la Localisation (villes, livraison).
- [x] Mise à jour de la Stack Technique (Crawl4AI, LlamaIndex Hybrid, Evolution API).
- [x] Actualisation de l'état d'avancement et de la vision "Pure Sémantique".
...
**Critères d'Acceptation** :
- [x] Retrait du message "Ana f Casablanca" et de la logique d'onboarding ville.
